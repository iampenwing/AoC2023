-- AdventOfCode 2023 Day 9, Puzzle 2
-- Mirage Maintenance
...
prevInSeq :: [[Integer]] -> Integer
prevInSeq [] = 0
prevInSeq (seq:seqs) = (head seq) - (prevInSeq seqs)
...
main = do
  ...
  let answer = foldr1 (+) (map prevInSeq (map generateDifferences (map (reverse . AoC.getInts) (lines fileContents))))
